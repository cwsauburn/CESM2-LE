...
% size is 500*90
i = 1;
filename = ['Ann_tas_CESM2_LE_RPC_global_continent_1951_2014_trend_',num2str(i),'.nc'];
P_corre0 = ncread(filename,'P_corre0');
denomin  = ncread(filename,'denomin');
RPC      = ncread(filename,'RPC');

copyfile Ann_tas_CESM2_LE_RPC_global_continent_1951_2014_trend_1.nc Ann_tas_CESM2_LE_RPC_global_continent_1951_2014_trend.nc 

i = 2;
filename2 = ['Ann_tas_CESM2_LE_RPC_global_continent_1951_2014_trend_',num2str(i),'.nc'];
P_corre02 = ncread(filename2,'P_corre0');
denomin2  = ncread(filename2,'denomin');
RPC2      = ncread(filename2,'RPC');

P_corre0(:,7:10) = P_corre02(:,7:10);
denomin(:,7:10)  = denomin2(:,7:10);
RPC(:,7:10)      = RPC2(:,7:10);
...
ncwrite('Ann_tas_CESM2_LE_RPC_global_continent_1951_2014_trend.nc','P_corre0',P_corre0)
ncwrite('Ann_tas_CESM2_LE_RPC_global_continent_1951_2014_trend.nc','denomin',denomin)
ncwrite('Ann_tas_CESM2_LE_RPC_global_continent_1951_2014_trend.nc','RPC',RPC)
%}
%%
% size is 500 iteration *56 ens
P_corre0_temp = ncread('Ann_tas_CESM2_LE_RPC_global_continent_1951_2014_trend.nc','P_corre0');
denomin_temp  = ncread('Ann_tas_CESM2_LE_RPC_global_continent_1951_2014_trend.nc','denomin');
RPC_temp      = ncread('Ann_tas_CESM2_LE_RPC_global_continent_1951_2014_trend.nc','RPC');
...
% plot(x3,STR_CV(1:90,2),'--','color',[0.58,0.58,0.58],'Linewidth',1.8)
...
title('CESM2-LE TAS RPC trend 1951-2014','FontSize',14)
