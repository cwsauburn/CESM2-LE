...
filename      = 'Ann_tas_CMIP6_NorCPM1_RPC_global_continent_1951_2014_trend_1.nc';
...
filename      = 'Ann_tas_CMIP6_NorCPM1_RPC_global_continent_1951_2014_trend_3.nc';
P_corre0_temp = ncread(filename,'P_corre0');
denomin_temp  = ncread(filename,'denomin');
RPC_temp      = ncread(filename,'RPC');
...
filename = 'Ann_tas_CMIP6_NorCPM1_RPC_global_continent_1951_2014_trend_2.nc';
P_corre0_temp = ncread(filename,'P_corre0');
denomin_temp  = ncread(filename,'denomin');
RPC_temp      = ncread(filename,'RPC');
...
title('NorCPM1 TAS RPC trend 1951-2014','FontSize',14)
