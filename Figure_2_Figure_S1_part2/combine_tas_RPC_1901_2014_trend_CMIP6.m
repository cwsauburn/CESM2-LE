...
filename = ['Ann_tas_CMIP6_RPC_global_continent_1901_2014_trend_',num2str(i),'.nc'];
...
ncwrite('Ann_tas_CMIP6_RPC_global_continent_1901_2014_trend.nc','P_corre0',P_corre0)
ncwrite('Ann_tas_CMIP6_RPC_global_continent_1901_2014_trend.nc','denomin',denomin)
ncwrite('Ann_tas_CMIP6_RPC_global_continent_1901_2014_trend.nc','RPC',RPC)

%%

% size is 500 iteration *56 ens
P_corre0 = ncread('Ann_tas_CMIP6_RPC_global_continent_1901_2014_trend.nc','P_corre0');
denomin  = ncread('Ann_tas_CMIP6_RPC_global_continent_1901_2014_trend.nc','denomin');
RPC      = ncread('Ann_tas_CMIP6_RPC_global_continent_1901_2014_trend.nc','RPC');
...
% plot(xCV,STR_CV(1:220,1),'--','color',[0.58,0.58,0.58],'Linewidth',1.8)
...
title('CMIP6 TAS RPC trend 1901-2014','FontSize',14)
