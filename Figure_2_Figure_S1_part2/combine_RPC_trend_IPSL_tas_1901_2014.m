...
P_corre0 = zeros(500,17);
denomin  = zeros(500,17);
RPC      = zeros(500,17);

filename      = 'Ann_tas_CMIP6_IPSL_RPC_global_continent_1901_2014_trend_1.nc';
...
filename      = 'Ann_tas_CMIP6_IPSL_RPC_global_continent_1901_2014_trend_3.nc';
P_corre0_temp = ncread(filename,'P_corre0');
denomin_temp  = ncread(filename,'denomin');
RPC_temp      = ncread(filename,'RPC');
...
filename      = 'Ann_tas_CMIP6_IPSL_RPC_global_continent_1901_2014_trend_2.nc';
P_corre0_temp = ncread(filename,'P_corre0');
denomin_temp  = ncread(filename,'denomin');
RPC_temp      = ncread(filename,'RPC');
...
title('IPSL CM6A LR TAS RPC trend 1901-2014','FontSize',14)
