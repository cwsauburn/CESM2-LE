...
filename = ['RPC_global_continent_1951_2014_1000_sample_CRUT_trend_CanESM5_',num2str(i),'.nc'];
Siglv_Can = ncread(filename,'Siglv_final_Had');

copyfile RPC_global_continent_1951_2014_1000_sample_CRUT_trend_CanESM5_21.nc RPC_global_continent_1951_2014_1000_sample_CRUT_trend_CanESM5.nc 
...
ncwrite('RPC_global_continent_1951_2014_1000_sample_CRUT_trend_CanESM5.nc','Siglv_final_Had',Siglv_Can)

%%
clc,clear
i = 12;

filename = ['RPC_global_continent_1951_2014_1000_sample_CRUT_trend_IPSL_',num2str(i),'.nc'];
Siglv_IPSL = ncread(filename,'Siglv_final_Had');

copyfile RPC_global_continent_1951_2014_1000_sample_CRUT_trend_IPSL_12.nc RPC_global_continent_1951_2014_1000_sample_CRUT_trend_IPSL.nc
for i = 1:11
...
ncwrite('RPC_global_continent_1951_2014_1000_sample_CRUT_trend_IPSL.nc','Siglv_final_Had',Siglv_IPSL)

%%
clc,clear
i = 11;

filename = ['RPC_global_continent_1951_2014_1000_sample_CRUT_trend_NorCPM1_',num2str(i),'.nc'];
Siglv_final_Had = ncread(filename,'Siglv_final_Had');

copyfile RPC_global_continent_1951_2014_1000_sample_CRUT_trend_NorCPM1_11.nc RPC_global_continent_1951_2014_1000_sample_CRUT_trend_NorCPM1.nc
for i = 1:10
...
ncwrite('RPC_global_continent_1951_2014_1000_sample_CRUT_trend_NorCPM1.nc','Siglv_final_Had',Siglv_final_Had)

%%

i = 1;
% 500*90
filename = ['Ann_tas_CESM2-LE_RPC_global_continent_1951_2014_1000_sample_CRUT_trend_',num2str(i),'.nc'];
Siglv_Can = ncread(filename,'Siglv_final_Had');

copyfile Ann_tas_CESM2-LE_RPC_global_continent_1951_2014_1000_sample_CRUT_trend_1.nc Ann_tas_CESM2-LE_RPC_global_continent_1951_2014_1000_sample_CRUT_trend.nc 
...
ncwrite('Ann_tas_CESM2-LE_RPC_global_continent_1951_2014_1000_sample_CRUT_trend.nc','Siglv_final_Had',Siglv_Can)

%%
clc,clear
i = 22;

filename        = ['RPC_global_continent_1951_2014_1000_sample_CRUT_trend_',num2str(i),'.nc'];
Siglv_final_Had = ncread(filename,'Siglv_final_Had');

copyfile RPC_global_continent_1951_2014_1000_sample_CRUT_trend_22.nc RPC_global_continent_1951_2014_1000_sample_CRUT_trend.nc
for i = 1:21
...
ncwrite('RPC_global_continent_1951_2014_1000_sample_CRUT_trend.nc','Siglv_final_Had',Siglv_final_Had)

%%

Siglv_Can       = ncread('RPC_global_continent_1951_2014_1000_sample_CRUT_trend_CanESM5.nc','Siglv_final_Had');
Siglv_IPSL      = ncread('RPC_global_continent_1951_2014_1000_sample_CRUT_trend_IPSL.nc','Siglv_final_Had');
Siglv_final_Had = ncread('RPC_global_continent_1951_2014_1000_sample_CRUT_trend.nc','Siglv_final_Had');
Siglv_Nor       = ncread('RPC_global_continent_1951_2014_1000_sample_CRUT_trend_NorCPM1.nc','Siglv_final_Had');
Siglv_CESM_temp = ncread('Ann_tas_CESM2-LE_RPC_global_continent_1951_2014_1000_sample_CRUT_trend_2_5_degree.nc','Siglv_final_Had');
